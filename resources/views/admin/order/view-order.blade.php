                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Order Total</th>
                                        <td>SAR {{$orderDetails->order_total}}</td>
                                    </tr>
                                    <tr>
                                        <th>Order Status</th>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>Customer name</th>
                                        <td>{{$orderDetails->shipping->first_name.' '.$orderDetails->shipping->last_name}}</td>
                                    </tr>
                                    <tr>
                                        <th>Phone No.</th>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>Full name</th>
                                        <td>{{$orderDetails->shipping->first_name}}</td>
                                    </tr>
                                    <tr>
                                        <th>Phone No.</th>
                                        <td>{{$orderDetails->shipping->phone_no}}</td>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>SAR. {{$productDetail->product_price}}</td>
                                        <td>{{$productDetail->product_quantity}}</td>
                                        <td>SAR {{$productDetail->product_quantity*$productDetail->product_price}}</td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
